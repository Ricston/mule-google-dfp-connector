...
@MetaDataCategory
public class PerformReconciliationOrderReportsCategory {
    ...
    public List<MetaDataKey> getMetaDataKeys() throws Exception {
        ...
        keys.add(new DefaultMetaDataKey("Revert Reconciliation Order Reports", "Revert Reconciliation Order Reports"));
        keys.add(new DefaultMetaDataKey("Submit Reconciliation Order Reports", "Submit Reconciliation Order Reports"));
