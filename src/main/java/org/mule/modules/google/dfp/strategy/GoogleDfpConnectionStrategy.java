 ...
 * @author MuleSoft, Inc.
 */
@ConnectionManagement(friendlyName = "Configuration", configElementName = "google-dfp")
public class GoogleDfpConnectionStrategy {
    ...
    public void connect(@ConnectionKey String clientId,
        ...
        try {
            ...
            /**
             * Initialise all the Google DFP services on startup. Once initialised, each service is configured if necessary.
             */
            ...
            // Initialize and configure rate card service
            rateCardService = new RateCardService();

            // Initialize and configure audience segment service
            audienceSegmentService = new AudienceSegmentService();

            // Initialize and configure custom targeting service
            ...
            Credential oAuth2Credential = new OfflineCredentials.Builder()
                    ...
                    .withTokenUrlServer(tokenServerUrl)
                    .build()
                    .generateCredential();
    ...
    public void setAudienceSegmentService(AudienceSegmentService audienceSegmentService) {
    ...
    public void setCustomTargetingService(CustomTargetingService customTargetingService) {
