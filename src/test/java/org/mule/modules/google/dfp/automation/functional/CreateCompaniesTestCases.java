...
public class CreateCompaniesTestCases extends AbstractTestCase<GoogleDfpConnector> {

    public CreateCompaniesTestCases() {
    ...
    public void testCreateCompany() throws Exception {
        createdCompany = getConnector().createCompanies(Arrays.asList(newCompany))[0];
    ...
    public void tearDown() throws Exception {
        ...
        getConnector().updateCompanies(Arrays.asList(createdCompany));
    }
}
